	...
	public void reservation(ArrayList<Bus> busList) {
		...
		for (int i = 1; i < 4;) {
			...
			for (int x = 1; x == 1;) {
				...
				System.out.println("********************************************");
				System.out.println("********************************************\n");
				if ((busList.get(0).getSeatNo() == 0) && (busList.get(1).getSeatNo() == 0)
						&& (busList.get(2).getSeatNo() == 0) && (busList.get(3).getSeatNo() == 0)
						&& (busList.get(4).getSeatNo() == 0) && (busList.get(5).getSeatNo() == 0)
						&& (busList.get(6).getSeatNo() == 0) && (busList.get(7).getSeatNo() == 0)
						&& (busList.get(8).getSeatNo() == 0) && (busList.get(9).getSeatNo() == 0)
						&& (busList.get(10).getSeatNo() == 0) && (busList.get(11).getSeatNo() == 0)
						&& (busList.get(12).getSeatNo() == 0) && (busList.get(13).getSeatNo() == 0)
						&& (busList.get(14).getSeatNo() == 0) && (busList.get(15).getSeatNo() == 0)
						&& (busList.get(16).getSeatNo() == 0) && (busList.get(17).getSeatNo() == 0)
						&& (busList.get(18).getSeatNo() == 0) && (busList.get(19).getSeatNo() == 0)
						&& (busList.get(20).getSeatNo() == 0) && (busList.get(21).getSeatNo() == 0)
						&& (busList.get(22).getSeatNo() == 0) && (busList.get(23).getSeatNo() == 0)
						&& (busList.get(24).getSeatNo() == 0) && (busList.get(25).getSeatNo() == 0)
						&& (busList.get(26).getSeatNo() == 0) && busList.get(27).getSeatNo() == 0) {
